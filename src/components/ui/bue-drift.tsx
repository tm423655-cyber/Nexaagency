...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      resizeCanvas()
      // canvas/gl are narrowed to non-null right above the two early returns
      // at the top of the effect, but TypeScript doesn't carry that narrowing
      // into this nested function declaration — assert it back, same as the
      // other WebGL calls in this file.
